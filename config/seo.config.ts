...
export const seoConfig: Record<string, SEOConfig> = {
  'sip-calculator': {
    ...
    metaTitle: 'SIP Calculator - Calculate Mutual Fund Returns India 2026 | calculox',
    metaDescription: 'Advanced SIP calculator for mutual fund investments. Calculate returns with step-up SIP, monthly investments, and 25+ year projections. RBI-compliant formulas. Free, instant results.',
    keywords: [
      'sip calculator',
  ...
  'emi-calculator': {
    ...
    metaTitle: 'EMI Calculator India 2026 - Home, Car & Personal Loan | calculox',
    metaDescription: 'Free EMI calculator for home loan, car loan, personal loan & vehicle loan. Calculate monthly EMI, total interest, and get detailed amortization schedule instantly. No registration needed.',
    keywords: [
      'emi calculator',
      'loan emi calculator',
  ...
  'bmi-calculator': {
    ...
    metaTitle: 'BMI Calculator India - Body Mass Index & Health Status | calculox',
    metaDescription: 'Free BMI calculator with WHO health categories. Calculate your Body Mass Index, get health recommendations, and understand ideal weight ranges. Accurate for adults, metric & imperial units.',
    keywords: [
      'bmi calculator',
