    ...
    <div className="space-y-12">
      ...
      <section className="text-center py-12 md:py-20">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
          Premium online calculators for your financial, health, and daily calculations. Fast, accurate, and completely free.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          <details className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            <summary className="font-semibold cursor-pointer">Are these calculators free to use?</summary>
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Yes! All our calculators are completely free and don&apos;t require any registration or payment.
            </p>
          </details>
          <details className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            <summary className="font-semibold cursor-pointer">Is my data secure?</summary>
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Yes. All calculations happen in your browser. We never store or transmit your personal data.
            </p>
          </details>
          <details className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            <summary className="font-semibold cursor-pointer">Will you add more calculators?</summary>
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Yes! We&apos;re constantly adding new calculators based on user feedback. Check back soon.
            </p>
          </details>
        </div>
      </section>
