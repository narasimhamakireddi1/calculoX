            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('years', e.target.value === '' ? 0 : Number(e.target.value))}
                  onBlur={(e) => handleValidateField('years', Number(e.target.value))}
                  className="w-full md:w-28 px-2 py-2 text-center border-2 border-orange-400 rounded-lg font-bold text-orange-700 bg-orange-50 dark:bg-orange-900/20 dark:text-orange-400 dark:border-orange-700 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
              </div>
        ...
        <div className="min-w-0">
          {result ? (
            <div id="cagr-results" className="card space-y-4">
              ...
              {/* Secondary metric */}
              <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/20 p-3 sm:p-4 rounded-lg border border-green-200 dark:border-green-700 shadow-sm">
                ...
                <p className="text-sm sm:text-lg font-bold text-green-700 dark:text-green-400">{result.cagr.toFixed(4)} <span className="text-xs font-normal text-green-600 dark:text-green-400">({(result.cagr + 1).toFixed(4)}x growth multiple)</span></p>
              </div>
