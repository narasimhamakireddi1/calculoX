...
import { MessageCircle, Clipboard, Check, Lock } from 'lucide-react';
    ...
    <>
      ...
      <div className={`relative z-10 max-w-2xl mx-auto mt-6 bg-white/90 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl border ${meta.border} shadow-xl p-6 md:p-8 text-left transition-colors duration-300`}>
        ...
        <div className="mt-6 pt-5 border-t border-gray-100 dark:border-gray-800">
            ...
            <>
              <div className="text-center mb-4">
                <div className="text-3xl font-extrabold text-blue-600 dark:text-blue-400 tabular-nums">
                  ...
                  <span className="text-base font-normal text-gray-500 dark:text-gray-400 ml-1">/mo</span>
                </div>
          ...
          {activeTab === 'retirement' && (
            <>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-orange-50 dark:bg-orange-900/10 rounded-xl px-4 py-3 text-center">
                  <div className="text-lg font-bold text-orange-500 dark:text-orange-400 tabular-nums">{formatINR(retireResult.sipNeeded)}<span className="text-xs font-normal text-gray-500 dark:text-gray-400 ml-0.5">/mo</span></div>
        ...
        <div className="mt-4 flex items-center gap-2 flex-wrap">
          <span className="text-[11px] text-gray-500 dark:text-gray-400 font-semibold uppercase tracking-widest mr-1">Share:</span>
          <a
