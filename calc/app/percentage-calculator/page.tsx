...
import { TrendingUp, TrendingDown, Target, BarChart2, RefreshCw, Search, Hash, ShoppingBag, HelpCircle, Calculator, BookOpen, Lightbulb, Trash2, AlertTriangle, ChevronRight } from 'lucide-react';
...
export default function PercentageCalculatorPage() {
  const [result, setResult] = useState<PercentageResultData | null>(() => {
    try { return calculatePercentage({ valueA: 20, valueB: 500, percentC: 4, hikeDirection: 'hike', calculationType: 'percent-of' }); } catch { return null; }
  });
  ...
  return (
    <div className="space-y-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Form */}
        <div id="percentage-inputs" className="card min-w-0">
      ...
      <RelatedBlogPosts posts={getRelatedBlogPosts('/percentage-calculator')} />
