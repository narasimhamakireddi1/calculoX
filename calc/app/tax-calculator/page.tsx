...
import { Briefcase, UserRound, IndianRupee, Home, Landmark, BarChart2, Trash2, BookOpen, Lightbulb, TrendingUp, Search, HelpCircle, Clock, Coins, CheckCircle2, PieChart, Sparkles, ChevronRight } from 'lucide-react';
...
export default function TaxCalculator() {
  const [result, setResult] = useState<ComprehensiveTaxResult | null>(() => {
    try {
      return calculateComprehensiveTax({
        profile: { age: 'below60', residentialStatus: 'resident', employerType: 'private' },
        salary: { grossSalary: 500000, basicSalary: 300000, hraReceived: 100000, rentPaid: 60000, cityType: 'non-metro', lta: 25000, epfEmployee: 50000, incomeHouseProperty: 0, incomeOtherSources: 0, npsEmployerContribution: 0 },
        deductions: { epf: 50000, ppf: 50000, elss: 0, lifeInsurance: 0, homeRepayment: 0, ssy: 0, nsc: 0, taxSaverFD: 0, tuitionFees: 0, npsAdditional: 0, healthInsuranceSelf: 15000, healthInsuranceParents: 0, parentsAge: 'below60', educationLoanInterest: 0, donations100: 0, donations50: 0, savingsInterest: 0, homeLoanInterest: 0 },
        regime: 'auto',
      });
    } catch { return null; }
  });
                ...
                <div>
                  ...
                  <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center">
                    ...
                    <input
                      ...
                      className="w-full md:w-28 px-2 py-2 text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none border-2 border-red-400 rounded-lg font-bold text-red-700 bg-red-50 dark:bg-red-900/20 dark:text-red-400 dark:border-red-700"
                      placeholder="0"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center">
                    ...
                    <input
                      ...
                      className="w-full md:w-28 px-2 py-2 text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none border-2 border-amber-400 rounded-lg font-bold text-amber-700 bg-amber-50 dark:bg-amber-900/20 dark:text-amber-400 dark:border-amber-700"
                      placeholder="0"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center">
                    ...
                    <input
                      ...
                      className="w-full md:w-28 px-2 py-2 text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none border-2 border-cyan-400 rounded-lg font-bold text-cyan-700 bg-cyan-50 dark:bg-cyan-900/20 dark:text-cyan-400 dark:border-cyan-700"
                      placeholder="0"
                    />
                  </div>
              ...
              {getRegimeResult() && (
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 p-3 sm:p-4 rounded-lg border border-purple-200 dark:border-purple-700 shadow-sm min-w-0">
