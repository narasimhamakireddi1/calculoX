            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {relatedPosts.map((related) => (
                <Link
                  ...
                  className="group rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800 hover:shadow-lg hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300 flex flex-col h-full"
                >
                  <div className="p-5 flex flex-col flex-1">
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full self-start mb-3 ${categoryColors[related.category] ?? 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200'}`}>
                      {related.category}
                    </span>
                    <p className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 leading-snug line-clamp-2 flex-1 mb-3">
                      {related.title}
                    </p>
